...
REQUIRED = [
    ...
    "botocore",
    "click",
    "datacube[s3,performance]==1.9.18",
    "dea-tools",
    "eo-tides",
    "Fiona",
    "geopandas",
    ...
    "mapclassify",
    "numpy",
    "odc-algo @ git+https://github.com/opendatacube/odc-algo.git",
    "odc-geo",
    "odc-stac>=0.5.0",
    "odc_ui",
    "pandas",
    ...
    "pydantic",
    "pyproj",
    "pyTMD @ git+https://github.com/piksel-ina/pyTMD.git@2.2.9-with-INATIDES",
    "python_geohash",
    "pytz",
    "PyYAML",
    "rasterio>=1.4.3",
